// C++ code
//Shortest Job First Scheduling associates with each process the length of the process next CPU burst.
...
void shortest_job(){
  ...
  while (count != 6){
    ...
    count++;
  } //executes shortest job first scheduling.
}